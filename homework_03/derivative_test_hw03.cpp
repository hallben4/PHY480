...
//      03/29/20  modified for homework 3
//
//  Notes:
...
main (void)
{
    ...
    double diff_extrap2;        // second extrapolated derivative
    double diff_gsl_cd;        // gsl adaptive central derivative
    gsl_function My_F;        // gsl_function type
    double abserr;                // absolute error
    
    ofstream out ("derivative_test_hw03.dat");    // open the output file
    ...
    while (h >= hmin)
    {
        ...
        diff_extrap2 = extrap_diff2 (x, h, &funct, params_ptr); // Calculate using extrap_diff2
