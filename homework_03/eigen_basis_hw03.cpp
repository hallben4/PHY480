...
main ()
{
    ...
    // Load the Hamiltonian matrix pointed to by Hmat_ptr
        ...
        ofstream eigen_basis_file ("eigen_basis_d" + to_string(dimension) + ".dat");
        ...
        for (double r = 0; r < 5; r += 0.05)
        {
            ...
            // Loop through number of basis functions
            for (int j = 0; j < dimension; j++)
            {
            ...
            // Write eigenvector
            eigen_basis_file << scientific << r << "  " << eigenvector << endl;
